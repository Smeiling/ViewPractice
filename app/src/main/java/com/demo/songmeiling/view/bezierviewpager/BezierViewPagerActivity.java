package com.demo.songmeiling.view.bezierviewpager;
...
import com.demo.songmeiling.view.bezierviewpager.vPage.BezierViewPager;
import com.demo.songmeiling.view.bezierviewpager.vPage.CardPagerAdapter;
import com.demo.songmeiling.view.bezierviewpager.vPage.LocalPagerAdapter;
...
//        float heightRatio = 0.565f;  //高是宽的 0.565 ,根据图片比例
        float heightRatio = 1.5f;
        CardPagerAdapter cardAdapter = new CardPagerAdapter(getApplicationContext());
        LocalPagerAdapter pagerAdapter = new LocalPagerAdapter(getApplicationContext());
        ...
        localList.add("e");
        localList.add("f");
        pagerAdapter.addImgUrlList(localList);
