...
public class MultiItemActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < size; i++) {
            postItem = new HomeItem();
            postItem.setHeaderUrl("http://static.coolcto.com/1496195692502.png");
            postItem.setUserNick("SML");
            postItem.setContentTitle("I'm title");
            postItem.setContentText("I'm text");
            postItem.setContentImgUrl("http://static.coolcto.com/@/20170713/99413aa8-ffe3-4a74-9b8e-96f49d8a67da/001.gif");
            postItem.setReviewCount(10);
            postItem.setReviewCount(4);
        ...
        mMenuAdapter = new MenuAdapter(this, postList);
    ...
    private RecyclerView.OnScrollListener mOnScrollListener = new RecyclerView.OnScrollListener() {
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            if (!recyclerView.canScrollVertically(1)) {// 手指不能向上滑动了
                ...
                Toast.makeText(MultiItemActivity.this, "滑到最底部了，去加载更多吧！", Toast.LENGTH_SHORT).show();
                size += 10;
                HomeItem postItem;
                for (int i = 0; i < size; i++) {
                    postItem = new HomeItem();
